...
function advertBox () {
  ...
  var mainPicture = floats[Math.floor(population.members[counter].code[7]*3)];
  var otherDisplay1 = display[Math.floor(population.members[counter].code[8]*3)];
  var otherDisplay2 = display[Math.floor(population.members[counter].code[9]*3)];
  var otherDisplay3 = display[Math.floor(population.members[counter].code[10]*3)];
...
action.addEventListener("click", function (e) {
  ...
  orbit.post("/data.json", population, function () {
  });
});
